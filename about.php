...
<body>
              ...
              <div class="js-main-image">
                <div class="member-detail-image">
                  ...
                  <div class="member-detail-desc">
                    ...
                    <p class="member-data"><span class="member-label">Umur:</span> <span class="js-member-age">27 tahun</span></p>
                    <p class="member-data"><span class="member-label">Skill:</span> <span class="js-member-skill">Tour Guide</span></p>
                    <p class="member-data"><span class="member-label">Bahasa:</span> <span class="js-member-lang">Multilingual (Indonesia/Inggris)</span></p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script type="text/javascript">
    var mainimage = $(".js-member-image");
    var mainname = $(".js-member-name");
    var maindesc = $(".js-member-desc");
    var thumbimage = $(".js-member-thumbnail-item");

    $(thumbimage).click(function() {
      var thethumbnail = $(this).find(".js-thumbnail-item-image").attr("src");
      var thename = $(this).find(".js-thumbnail-name").text();
      var thedesc = $(this).find(".js-thumbnail-desc").text();
      mainimage.fadeOut(1000, function() {
        mainimage.attr("src", thethumbnail);
        mainname.text(thename);
