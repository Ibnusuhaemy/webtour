          ...
          <div class="col-xs-6 col-sm-6 col-md-3 footer-menu-article">
            ...
            <div class="media article-media">
              <div class="media-left article-media-photo">
                <a href="#">
                  <img class="media-object" src="images/thumbnails/jagadtour-ig-2.jpg" width="490" height="490"
                    alt="Jagadtour Artikel">
                </a>
              </div>
            ...
            <div class="media article-media">
              <div class="media-left article-media-photo">
                <a href="#">
                  <img class="media-object" src="images/thumbnails/jagadtour-ig-1.jpg" width="452" height="490"
                    alt="Jagadtour Artikel">
                </a>
              </div>
              <div class="media-body media-middle">
            ...
            <div class="media article-media">
              <div class="media-left article-media-photo">
                <a href="#">
                  <img class="media-object" src="images/thumbnails/jagadtour-ig-6.jpg" width="478" height="490"
                    alt="Jagadtour Artikel">
                </a>
              </div>
              <div class="media-body media-middle">
