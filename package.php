            ...
            <div class="panel-group card-group" id="js-package" role="tablist" aria-multiselectable="true">
              ...
              <div class="panel panel-default panel-complete content-packdetail-panel packdetail-itinerary">
                ...
                <div id="js-package-itinerary" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-itinerary">
                  <div class="panel-body panel-complete-content">
<!--
                    <ul class="list-inline packdetail-itinerary-list">
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-pin-location"></i>
                        <time>00.30</time>
                        <p>Penjemputan Peserta di Meeting Point</p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-road"></i>
                        <time>02.30</time>
                        <p>Sampai di Park Area <b>Wonokitri Parking Area</b> (Oper Jeep 4X4) / di Villa Transit</p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-car"></i>
                        <time>03.00</time>
                        <p>Menuju ke Penanjakan 1 <b>Spot Golden Sunrise</b></p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-coffee"></i>
                        <time>04.00</time>
                        <p><b>Coffee Time</b> Sambil Sunrise Tiba</p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-camera"></i>
                        <time>08.30</time>
                        <p>Spot Foto / lewat <b>Pasir Berbisik</b></p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-picture"></i>
                        <time>07.00</time>
                        <p>Explore Spot <b>Kawah Bromo</b> dan <b>Pura Poten</b></p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-car"></i>
                        <time>06.00</time>
                        <p>Menuju ke <b>Lautan Pasir</b></p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-camera"></i>
                        <time>05.00</time>
                        <p>Enjoy Sunrise Bromo, <b>Capture It</b> (Jika spot penanjakan masih kurang puas, bisa ke spot Bukit Kingong / Bukit Cinta)</p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-people"></i>
                        <time>09.00</time>
                        <p>Spot di savana <b>Bukit Teletubies</b> sampe puas</p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-road"></i>
                        <time>10.30</time>
                        <p><b>Kembali</b> di Park Area Wonokitri</p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-shower"></i>
                        <time>11.30</time>
                        <p>Bersih diri, Makan pagi (biaya pribadi) dan kembali ke Meeting Point</p>
                      </li>
                      <li class="itinerary-list-item">
                        <i class="jgicon icon-pin-location"></i>
                        <time>13.30</time>
                        <p>Diperkirakan tiba di Meeting Point</p>
                      </li>
                    </ul>
-->
          ...
          <div class="col-md-4">
            ...
            <div class="panel panel-default panel-complete packother-panel">
              <div class="panel-heading panel-complete-heading panel-heading-orange">
...
<footer class="footer js-footer">
    ...
    <script type="text/javascript">
      ...
      // $(document.getElementById("btnsubmitticket")).click(function(e) {
